...
export const NotificationUserProvider = ({children}) => {
  ...
  return (
    <>
      <NotificationContext.Provider value={
        {notify}}>
        <div className={`${styles.MiniMessages__Main} ${isActive ? "" : styles.Inactive}`}>
          <div className={styles.MiniMessages__Wrapper}>
            <div className={styles.MiniMessages__Header}>
              <EmptyButton action={() => {setIsActive(false)}}>
                <div>
            ...
            <div className={styles.MiniMessages__Body}>
              {message}
            </div>
          </div>
        </div>
